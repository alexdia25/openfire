...
compass, the radar grid/brackets, the slide-in; the 3x scale and the bottom-left position are the port's; the bar colours are the unverified 15-bit reading.
