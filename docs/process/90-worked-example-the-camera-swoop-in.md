...
- **The leaves overhang the tile at large offsets** (a leaf 16 wide at `0.3 * age + 5` reaches x = 31 at its widest, past the tile's edge at 16), which hides the pit surround's side borders for a moment; whether the original clips the pit to the pad is untraced (the footage shows the border intact).
