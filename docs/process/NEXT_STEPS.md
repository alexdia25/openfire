...
- **Moddability framework (user direction, 2026-09-24)** — one data-driven vehicle framework, per-map vehicle rosters with override files, split-up art; steps 1-2 (layered packs; sprite ids and loose-frame art) done, steps 3-7 open — plan section 2.7; the editor itself is planned in [`EDITOR_PLAN.md`](../EDITOR_PLAN.md), phase E0 built (`editor/`).
